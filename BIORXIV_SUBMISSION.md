# bioRxiv Submission — Ready-to-Post Checklist
...
## On the bioRxiv portal you will select / provide
1. **Corresponding author:** Suma Kasa — ksuma2109@gmail.com (get a free **ORCID** first; bioRxiv links it).
2. **Subject category:**
   - Paper 1 → **Bioinformatics** (secondary: Cancer Biology)
   - Paper 2 → **Cancer Biology** (secondary: Immunology)
3. **License:** choose one — CC-BY (most permissive/reusable, recommended), CC-BY-NC-ND, or "No reuse." CC-BY is standard for preprints.
4. **Competing interests:** "None" (matches the manuscript).
...
- Posting to bioRxiv does **not** prevent later journal submission (BiB and the cancer-immunology journals all allow preprints).
- After posting you get a **DOI** immediately — you can cite both papers and link them from the GitHub repo.
